...
from utils import InteractiveConvolutionBlock2D  # Import class from utils.py
import numpy as np
...
class ICB_CNN(nn.Module):
    def __init__(self, dropout_rate=0.25):
        super(ICB_CNN, self).__init__()
...
model_name = 'ICB_CNN'
model = ICB_CNN(dropout_rate=0.3).to(device)
...
for epoch in range(num_epochs):
    ...
    for images, labels in train_loader:
        ...
        with autocast():
            ...
            total_loss = loss  # No regularization loss needed for linear layers
